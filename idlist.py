...
"""
Generate a list of all game IDs from Steam.com.

These IDs will be used in games.py and steamspy.py to create
games.json and steamspy.json which will contain game features
and performance metrics, respectively.
